  ...
  return (
    <section className="flex flex-wrap gap-10 justify-between items-center px-4 py-1.5 mt-2 w-full font-semibold border-b border-lime-600 max-w-[1312px] min-h-[40px] max-md:max-w-full">
      <div className="flex gap-2 items-center self-stretch my-auto text-base text-lime-600 whitespace-nowrap">
        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/5119e1fcc1577c8ad172c085931fc39f2e03bdb8899b00e2c6fc9b46f319c55d?placeholderIfAbsent=true&apiKey=cc964368bac44d9ca0eed220fa7a4da9" alt="" className="object-contain shrink-0 self-stretch my-auto w-6 aspect-square" />
        <h2 className="self-stretch my-auto">Job Description</h2>
      </div>
