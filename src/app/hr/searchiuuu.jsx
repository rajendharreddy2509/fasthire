...
export default function SearchBar() {
  return (
    <div className="flex overflow-hidden gap-2.5 items-center self-stretch px-2  pb-12 py-1.5 my-auto font-light leading-none text-gray-400 whitespace-nowrap bg-white rounded-md shadow-sm min-h-[36px] min-w-[240px] w-[246px]">
