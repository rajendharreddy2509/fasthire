...
function SearchBar() {
  return (
    <form className="flex flex-wrap gap-1.5 items-center min-w-[240px] max-md:max-w-full">
      <div className="flex overflow-hidden gap-2.5 items-center self-stretch px-2 py-1.5 my-auto font-light leading-none text-gray-400 whitespace-nowrap bg-white rounded-md shadow-sm min-h-[36px] min-w-[240px] w-[246px]">
        ...
        <input type="text" id="search" placeholder="Search" className="self-stretch my-auto w-[119px] bg-transparent border-none focus:outline-none" />
      </div>
    </form>
  );
}
