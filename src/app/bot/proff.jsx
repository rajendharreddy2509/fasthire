 ...
 export default function ProfileInfo() {
  return (
    <div className="flex gap-1.5 items-center self-stretch my-auto">
      <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/9b9d0deb94edbc51529ae070a6c941023ea77dbec1049ebec2996eade67bc489?placeholderIfAbsent=true&apiKey=cc964368bac44d9ca0eed220fa7a4da9" alt="Profile picture" className="object-contain shrink-0 self-stretch my-auto w-9 aspect-square" />
