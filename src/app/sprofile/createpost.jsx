...
//   return (
//     <div className="flex flex-col px-4 py-4 w-full font-medium bg-white rounded-md border border-indigo-400 border-solid max-md:max-w-full">
//       <div className="flex gap-2.5 self-start text-lg text-slate-500">
//         <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/3c1c8960d870ef1d15dd7bf0229a653a760030a8873701adbb1da27e2957d99e?placeholderIfAbsent=true&apiKey=cc964368bac44d9ca0eed220fa7a4da9" alt="User avatar" className="object-contain shrink-0 w-11 rounded-full aspect-[0.98]" />
//         <input
//           type="text"
