          ...
          <div className="flex gap-9 items-center self-stretch my-auto min-h-[36px] w-[58px]">
            <div className="flex gap-1.5 items-center self-stretch my-auto">
              <div className="flex gap-4 items-center self-stretch my-auto">
                <div className="flex gap-1.5 items-center self-stretch my-auto">
                  <image loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/9b9d0deb94edbc51529ae070a6c941023ea77dbec1049ebec2996eade67bc489?placeholderIfAbsent=true&apiKey=cc964368bac44d9ca0eed220fa7a4da9" alt="" className="object-contain shrink-0 self-stretch my-auto w-9 aspect-square" />
                  ...
                  <image loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/c88c435fc1fa01526abbdd224bc7a45eff4ba2712a6af5f2a617e6719c192713?placeholderIfAbsent=true&apiKey=cc964368bac44d9ca0eed220fa7a4da9" alt="" className="object-contain shrink-0 self-stretch my-auto w-5 aspect-square" />
                </div>
              </div>
            </div>
          </div>
